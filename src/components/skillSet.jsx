...
function SkillSet() {
    ...
    return (
        <>
            <section className="justify-center items-center overflow-hidden mb-20 ml-2 mr-2">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4 border p-2 rounded-lg">
                    {frontedSkills.map((item , index)=>(
                        <div key={index} className="flex gap-4 p-2 bg-transparent hover:bg-slate-400 rounded-md ">
