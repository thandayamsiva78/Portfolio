      ...
      <section className="projects p-4 overflow-auto">
        ...
        <article className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {myProjects.map((item, index) => (
            <div
              key={index}
              className="shadow-lg bg-inherit rounded-lg p-2 w-full h-auto flex flex-col items-center transition-transform transform hover:scale-105 cursor-pointer group relative"
            >
