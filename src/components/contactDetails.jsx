...
function ContactDetails() {
    ...
    return (
        <>
            <section className="contactDetails grid grid-cols-2 justify-center items-center h-screen mt-10">
                <div className="">
                    ...
                    <div className="flex gap-4 items-center mt-8 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="blue" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="size-6">
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex flex-col gap-2 md:flex-row">
                        <input className="w-full p-3 rounded-sm  bg-slate-800 pl-4" type="text" name="" id="" placeholder="First Name" />
                        <input className="w-full p-3 rounded-sm  bg-slate-800 pl-4" type="text" name="" id="" placeholder="Last Name" />
                    </div>
                    <div className="flex flex-col gap-2 md:flex-row">
                        <input className="w-full p-3 rounded-sm  bg-slate-800 pl-4" type="text" name="" id="" placeholder="Email" />
                        <input className="w-full p-3 rounded-sm  bg-slate-800 pl-4" type="text" name="" id="" placeholder="Phone No" />
                    </div>
